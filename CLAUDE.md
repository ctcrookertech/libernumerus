...
node pythagorean/pythagorean.test.js
node hebrew-gematria/hebrew-gematria.test.js
node chaldean/chaldean.test.js
node vedic-indian/vedic-indian.test.js
node greek-isopsephy/greek-isopsephy.test.js
node arabic-abjad/arabic-abjad.test.js
node hurufism/hurufism.test.js
node thelemic/thelemic.test.js
node tarot/tarot.test.js
node chinese-cosmological/chinese-cosmological.test.js
node japanese-shinto/japanese-shinto.test.js
node mayan/mayan.test.js
node yoruba-ifa/yoruba-ifa.test.js
node norse-runic/norse-runic.test.js
node celtic-ogham/celtic-ogham.test.js
node neoplatonic/neoplatonic.test.js
node christian-symbolic/christian-symbolic.test.js
node egyptian/egyptian.test.js
```
...
- Each test file is standalone: `node <system>/<system>.test.js`
